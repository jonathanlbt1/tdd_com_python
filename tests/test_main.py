...
from tests.main import Usuario, Leilao, Lance
...
class TestLeilao(TestCase):
    ...
    def test_nao_deve_permitir_um_lance_em_ordem_decrescente(self):
    ...
    def test_deve_retornar_o_maior_e_o_menor_valor_quando_o_leilao_tiver_apenas_tres_lances(self):
